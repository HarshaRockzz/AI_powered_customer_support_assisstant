...
class RetrainManager:
    ...
    async def retrain(
        self, feedback_threshold: int = 10, model_name: Optional[str] = None
    ) -> Dict:
        """
        ...
        for sample in training_data:
            formatted_sample = {
                "messages": [
                    ...
                    {"role": "user", "content": sample.get("query", "")},
    ...
    async def _create_finetuning_job(
        self, training_data: List[Dict], model_name: Optional[str] = None
    ) -> str:
        """
